...
(8)dW[l]=∂L∂W[l]=1mdZ[l]A[l−1]T
db[l]=∂∂b[l]=1m∑i=1mdZ[l](i)(9)
(9)db[l]=∂L∂b[l]=1m∑i=1mdZ[l](i)
...
def L_model_backward(AL, Y, caches):
    ...
    current_cache = dAL
    grads["dA" + str(L-1)], grads["dW" + str(L)], grads["db" + str(L)] = linear_activation_backward(current_cache, caches[-1], 'sigmoid')
    ### END CODE HERE ###
    ...
    for l in reversed(range(L-1)):
        ...
        current_cache = grads['dA' + str(l+1)]
        dA_prev_temp, dW_temp, db_temp = linear_activation_backward(current_cache, caches[l], 'relu')
